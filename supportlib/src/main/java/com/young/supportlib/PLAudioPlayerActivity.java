...
import com.pili.pldroid.playerdemo.widget.Lrc;
import com.pili.pldroid.playerdemo.widget.LrcHelper;
import com.pili.pldroid.playerdemo.widget.LrcView;
...
public class PLAudioPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Lrc> lrcs = LrcHelper.parseLrcFromAssets(this, "thatgirl.lrc");
        mLrcView.setLrcData(lrcs);
        mLoadingView = findViewById(R.id.LoadingView);
        mAudioPath = getIntent().getStringExtra("videoPath");
        mAudioPath="https://resource.beilezx.com/upload%2Fa%2F2020%2F0415%2F1586934806921_1.mp3";
        ...
        public void onInfo(int what, int extra) {
            ...
            switch (what) {
                ...
                case MEDIA_INFO_AUDIO_FRAME_RENDERING:
                    Log.i("testAudio",extra+"__");
                    mLrcView.updateTime(extra);
                    break;
                default:
                    break;
            }
